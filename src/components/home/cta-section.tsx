...
import { AnimatedSection, scaleIn } from "@/components/shared/motion";
    ...
    <section className="py-24 sm:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection variants={scaleIn}>
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-900 via-stone-900 to-amber-950 px-8 sm:px-16 py-16 sm:py-24 text-center">
            {/* Decorative elements */}
            ...
            <div className="relative z-10">
              ...
              <p className="mt-4 text-white/60 text-lg max-w-md mx-auto">
                Place your order in minutes via WhatsApp. Fresh, premium dry
                fruits delivered to your door.
              </p>
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                <Button
                  asChild
                  size="lg"
                  className="rounded-full bg-white text-stone-900 hover:bg-white/90 text-base px-8 h-12 sm:h-14 font-semibold"
                >
